...
| 全体表示 | F | 選択オブジェクトを画面にフィット |
| シミュレーション | Space | シミュレーション開始/停止 |
| 選択ツール | A | Arrow ツールに切り替え |
| 四角形ツール | R | Rectangle ツールに切り替え |
| 円ツール | C | Circle ツールに切り替え |

### 表示モード一覧

| キー | 表示モード | 用途 |
|------|------------|------|
| 1 | Wireframe | 線のみ表示（軽い） |
| 2 | Shaded | 陰影付き表示（標準） |
| 3 | Textured | テクスチャ表示 |
| 4 | Rendered | 高品質レンダリング |